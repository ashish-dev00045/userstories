...
namespace Ashish\UserStory22\Controller\Adminhtml\Popup;

use Magento\Backend\App\Action;
use Ashish\UserStory22\Model\PopupFactory;
...
class Save extends Action
{
    ...
    public function execute()
    {
        ...
        if (!$data) {
            return $this->_redirect('userstory22/popup/index');
        }
        ...
        try {
            ...
            $this->dataPersistor->clear('userstory22_popup');
